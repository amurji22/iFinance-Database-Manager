...
public class IFinanceController implements Initializable {
    ...
    public void showGroups() throws Exception {
        this.groupsAdapter = new GroupsAdapter(this.conn, false );
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("AccountGroups.fxml"));
        Parent root = fxmlLoader.load();
        AccountGroupsController groupsController = fxmlLoader.getController();
        groupsController.setModel(this, this.groupsAdapter);
